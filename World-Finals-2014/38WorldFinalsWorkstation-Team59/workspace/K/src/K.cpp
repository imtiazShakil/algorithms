...
//        	print1(giveans(candi1[0].b+1,candi2[0].a-1));
        ...
        for(int i=0;i<500 && i<SZ(candi1);i++ ) ans=min( ans , giveans( candi1[i].b+1 , candi1[i].a-1 ) + 1 );
        for(int i=0;i<500 && i<SZ(candi2);i++ ) ans=min( ans , giveans( candi2[i].b+1 , candi2[i].a-1 ) + 1 );
